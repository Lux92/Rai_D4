...
Datapacket::Datapacket(const char *name, int kind) : ::omnetpp::cPacket(name,kind)
{
    this->idSource = 0;
    this->idDest = 0;
}
...
void Datapacket::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->idSource);
    doParsimPacking(b,this->matrice);
...
void Datapacket::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->idSource);
    doParsimUnpacking(b,this->matrice);
    doParsimUnpacking(b,this->idDest);
}

int Datapacket::getIdSource() const
{
    return this->idSource;
}

void Datapacket::setIdSource(int idSource)
{
    this->idSource = idSource;
}

Matrice& Datapacket::getMatrice()
{
    return this->matrice;
}

void Datapacket::setMatrice(const Matrice& matrice)
{
    this->matrice = matrice;
}

int Datapacket::getIdDest() const
{
    return this->idDest;
}

void Datapacket::setIdDest(int idDest)
{
    this->idDest = idDest;
}
...
int DatapacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='i' && strcmp(fieldName, "idSource")==0) return base+0;
    if (fieldName[0]=='m' && strcmp(fieldName, "matrice")==0) return base+1;
    if (fieldName[0]=='i' && strcmp(fieldName, "idDest")==0) return base+2;
...
std::string DatapacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    Datapacket *pp = (Datapacket *)object; (void)pp;
    switch (field) {
        case 0: return long2string(pp->getIdSource());
        case 1: {std::stringstream out; out << pp->getMatrice(); return out.str();}
        case 2: return long2string(pp->getIdDest());
        default: return "";
    }
}
...
bool DatapacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    Datapacket *pp = (Datapacket *)object; (void)pp;
    switch (field) {
        case 0: pp->setIdSource(string2long(value)); return true;
        case 2: pp->setIdDest(string2long(value)); return true;
...
const char *DatapacketDescriptor::getFieldStructName(int field) const
{
    ...
    switch (field) {
        case 1: return omnetpp::opp_typename(typeid(Matrice));
        default: return nullptr;
    };
}
...
void *DatapacketDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    ...
    Datapacket *pp = (Datapacket *)object; (void)pp;
    switch (field) {
        case 1: return (void *)(&pp->getMatrice()); break;
        default: return nullptr;
    }
}
...
void Applicationpacket::copy(const Applicationpacket& other)
{
    ...
    this->arrivTime = other.arrivTime;
}
...
void Applicationpacket::parsimPack(omnetpp::cCommBuffer *b) const
{
    ...
    doParsimPacking(b,this->arrivTime);
}
...
void Applicationpacket::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ...
    doParsimUnpacking(b,this->arrivTime);
}

::omnetpp::simtime_t Applicationpacket::getGenTime() const
{
    return this->genTime;
}

void Applicationpacket::setGenTime(::omnetpp::simtime_t genTime)
{
    this->genTime = genTime;
}

::omnetpp::simtime_t Applicationpacket::getArrivTime() const
{
    return this->arrivTime;
}

void Applicationpacket::setArrivTime(::omnetpp::simtime_t arrivTime)
{
...
int ApplicationpacketDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='a' && strcmp(fieldName, "arrivTime")==0) return base+1;
    return basedesc ? basedesc->findField(fieldName) : -1;
}
...
std::string ApplicationpacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 1: return simtime2string(pp->getArrivTime());
        default: return "";
    }
}
...
bool ApplicationpacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 1: pp->setArrivTime(string2simtime(value)); return true;
        default: return false;
    }
}
